...
export default function Sidebar() {
  ...
  return (
    <div className="  top-[65px] left-0 h-screen transition-transform -translate-x-full lg:translate-x-0  w-[380px] fixed bg-primary border-r border-[#587481]">
      <div className="h-full flex flex-row ">
        {/* Sidebar left section containing team icons */}
        ...
        {/* Sidebar right section containing team details and menu items */}
        <div className="lg:w-[70%] p-3 overflow-y-auto max-h-[90vh] scrollbar-hide ">
          <div className="flex items-center gap-3 mt-6">
            <img
              src={team.icon}
              className="h-10 w-10"
              alt="Selected Team Icon"
            />
            <h2 className="text-2xl">{team.name}</h2>
          </div>
          {/* Team card and menu items */}
          <TeamCard team={team.user} />
